...
/**
 * ✅ تابع کمکی برای نرمال‌سازی مقادیر متا در ریسپانس‌های API
 * برخی اوقات API ممکن است اعداد را به صورت آرایه تک‌عضوی (مثل [42]) برگرداند.
 * این تابع مطمئن می‌شود که خروجی همیشه یک عدد معتبر است.
 * * @param value مقدار خام دریافتی از API
 * @returns عدد نرمال شده یا 0
 */
export const normalizePaginationValue = (value: any): number => {
